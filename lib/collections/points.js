...
Points.helpers({
  /*
   * Grabs the urls out of the points and returns them back in an array.
   */
...
Points.before.insert(function (userId, message) {
  message.createdAt = new Date();
  message.userId = userId;
});

Points.before.update(function (userId, doc, fieldNames, modifier, options) {
